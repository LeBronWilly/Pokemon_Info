...
def Pokemon_data_refresh_ETL():
    ...
    pokemon_data['Type1'] = pokemon_data['Type1'].apply(lambda x: x.capitalize())
    pokemon_data['Type2'] = pokemon_data['Type2'].apply(lambda x: x.strip().capitalize() if x != None else "")
    pokemon_data["ID_Name_EN"] = pokemon_data["ID"].astype(str) + ". " + pokemon_data["Name_EN"]
    pokemon_data.index += 1
    pokemon_data = pokemon_data[["ID_Name_EN", 'ID', 'Name', 'Name_EN', "Type1", "Type2", "Type", "Type_EN",
...
class AppWindow(QWidget):  # Reusable
    ...
    def setup_control(self):  # Reusable
        ...
        self.ui.Pokemon_ID_Name = list(self.Pokemon_data["ID_Name_EN"])
    ...
    def Search_Button_Clicked(self, Pokemon_ID_Name):
        ...
        self.Pokemon_img = self.Pokemon_img.scaled(300, 300)
